...
describe("post", () => {
  ...
  beforeEach(() => {
    hexo.config = Object.assign({}, defaultConfig);
  });
  ...
  it("post - post_asset_folder enabled", async () => {
    ...
    const assetFiles = ["bar.jpg", "baz.png", "_fizz.jpg", "_buzz.jpg"].map(
      filename => {
