...
describe('code', () => {
  ...
  function code(args, content) { return codeTag(args.split(' '), content); }
  ...
  it('line_number', () => {
    ...
    result.should.eql(highlight(fixture, {gutter : false}));
    result = code('line_number:true', fixture);
    result.should.eql(highlight(fixture, {gutter : true}));
  });
  ...
  it('title', () => {
    ...
    result.should.eql(
        highlight(fixture, {caption : '<span>Hello world</span>'}));
  });
  ...
  it('first_line', () => {
    ...
    result.should.eql(highlight(fixture, {firstLine : 1234}));
    result = code('', fixture);
    result.should.eql(highlight(fixture, {firstLine : 1}));
  });

  it('mark', () => {
    const source = [
      'const http = require(\'http\');', '', 'const hostname = \'127.0.0.1\';',
      'const port = 1337;', '', 'http.createServer((req, res) => {',
  ...
  it('wrap', () => {
    ...
    result.should.eql(highlight(fixture, {wrap : false}));
    result = code('wrap:true', fixture);
    result.should.eql(highlight(fixture, {wrap : true}));
  });
});
