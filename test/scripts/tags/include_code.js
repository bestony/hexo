...
describe('include_code', () => {
  ...
  it('default', () => {
    ...
    return code('test.js').then(result => { result.should.eql(expected); });
  });
  ...
  it('title', () => {
    ...
    return code('Hello world test.js')
        .then(result => { result.should.eql(expected); });
  });
  ...
  it('lang', () => {
    ...
    return code('Hello world lang:js test.js')
        .then(result => { result.should.eql(expected); });
  });
  ...
  it('from', () => {
    ...
    return code('Hello world lang:js from:3 test.js')
        .then(result => { result.should.eql(expected); });
  });
  ...
  it('to', () => {
    ...
    return code('Hello world lang:js to:2 test.js')
        .then(result => { result.should.eql(expected); });
  });
  ...
  it('from and to', () => {
    ...
    return code('Hello world lang:js from:2 to:2 test.js')
        .then(result => { result.should.eql(expected); });
  });

  it('file not found',
     () => code('nothing').then(result => { should.not.exist(result); }));
