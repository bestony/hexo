...
describe("Meta Generator", () => {
  ...
  const hexo = new Hexo();
  const metaGenerator = require("../../../lib/plugins/filter/after_render/meta_generator").bind(
    hexo
  );
  ...
  it("no duplicate generator tag", () => {
    ...
    resultType(
      '<head><link><meta name="generator" content="foo"></head>'
    ).should.eql("undefined");
    resultType(
      '<head><link><meta content="foo" name="generator"></head>'
    ).should.eql("undefined");
  });
