...
describe("is", () => {
  ...
  it("is_current", async () => {
    await is.current
      .call({ path: "index.html", config: hexo.config })
      .should.eql(true);
    await is.current
      .call({ path: "tags/index.html", config: hexo.config })
      .should.eql(false);
    await is.current
      .call({ path: "index.html", config: hexo.config }, "/")
      .should.eql(true);
    ...
    await is.current
      ...
      .should.eql(true);
    await is.current
      .call({ path: "foo/bar", config: hexo.config }, "foo", true)
      .should.eql(false);
    await is.current
      .call({ path: "foo/bar", config: hexo.config }, "foo")
      .should.eql(true);
    await is.current
      .call({ path: "foo/bar", config: hexo.config }, "foo/bar")
      .should.eql(true);
    await is.current
      .call({ path: "foo/bar", config: hexo.config }, "foo/baz")
      .should.eql(false);
  });
  ...
  it("is_year", async () => {
    ...
    await is.year
      .call({ page: { archive: true, year: 2014 } })
      .should.eql(true);
    await is.year
      .call({ page: { archive: true, year: 2014 } }, 2014)
      .should.eql(true);
    await is.year
      .call({ page: { archive: true, year: 2014 } }, 2015)
      .should.eql(false);
    await is.year
      .call({ page: { archive: true, year: 2014, month: 10 } })
      .should.eql(true);
  });
  ...
  it("is_month", async () => {
    ...
    await is.month
      ...
      .should.eql(false);
    await is.month
      .call({ page: { archive: true, year: 2014, month: 10 } }, 10)
      .should.eql(true);
    await is.month
      .call({ page: { archive: true, year: 2014, month: 10 } }, 12)
      .should.eql(false);
  });
  ...
  it("is_category", async () => {
    ...
    await is.category
      .call({ page: { category: "foo" } }, "foo")
      .should.eql(true);
    await is.category
      .call({ page: { category: "foo" } }, "bar")
      .should.eql(false);
