...
describe('toc', () => {
  ...
  const html = [
    '<h1 id="title_1">Title 1</h1>', '<h2 id="title_1_1">Title 1.1</h2>',
    '<h3 id="title_1_1_1">Title 1.1.1</h3>',
    '<h2 id="title_1_2">Title 1.2</h2>', '<h2 id="title_1_3">Title 1.3</h2>',
    '<h3 id="title_1_3_1">Title 1.3.1</h3>', '<h1 id="title_2">Title 2</h1>',
  ...
  it('default', () => {
    ...
    const expected = [
      ...
      '<span class="' + className +
          '-number">1.</span> ', // list_number enabled
      ...
      '<span class="' + className +
          '-number">1.1.</span> ', // list_number enabled
      ...
      '<span class="' + className +
          '-number">1.1.1.</span> ', // list_number enabled
      ...
      '<span class="' + className +
          '-number">1.2.</span> ', // list_number enabled
      ...
      '<span class="' + className +
          '-number">1.3.</span> ', // list_number enabled
      ...
      '<span class="' + className +
          '-number">1.3.1.</span> ', // list_number enabled
      ...
      '<span class="' + className +
          '-number">2.</span> ', // list_number enabled
      ...
      '<span class="' + className +
          '-number">2.1.</span> ', // list_number enabled
      ...
      '<span class="' + className +
          '-number">3.</span> ', // list_number enabled
      '<span class="' + className +
      ...
      '<span class="' + className +
          '-number">4.</span> ', // list_number enabled
      '<span class="' + className +
  ...
  it('list_number', () => {
    ...
    const expected = [
      ...
      '<span class="' + className + '-text">Title 1</span>', '</a>',
      '<ol class="' + className + '-child">',
      '<li class="' + className + '-item ' + className + '-level-2">',
      '<a class="' + className + '-link" href="#title_1_1">',
      // '<span class="' + className + '-number">1.1.</span> ',
      '<span class="' + className + '-text">Title 1.1</span>', '</a>',
      '<ol class="' + className + '-child">',
      '<li class="' + className + '-item ' + className + '-level-3">',
      '<a class="' + className + '-link" href="#title_1_1_1">',
      // '<span class="' + className + '-number">1.1.1.</span> ',
      '<span class="' + className + '-text">Title 1.1.1</span>', '</a>',
      '</li>', '</ol>', '</li>',
      '<li class="' + className + '-item ' + className + '-level-2">',
      '<a class="' + className + '-link" href="#title_1_2">',
      // '<span class="' + className + '-number">1.2.</span> ',
      '<span class="' + className + '-text">Title 1.2</span>', '</a>', '</li>',
      '<li class="' + className + '-item ' + className + '-level-2">',
      '<a class="' + className + '-link" href="#title_1_3">',
      // '<span class="' + className + '-number">1.3.</span> ',
      '<span class="' + className + '-text">Title 1.3</span>', '</a>',
      '<ol class="' + className + '-child">',
      '<li class="' + className + '-item ' + className + '-level-3">',
      '<a class="' + className + '-link" href="#title_1_3_1">',
      // '<span class="' + className + '-number">1.3.1.</span> ',
      '<span class="' + className + '-text">Title 1.3.1</span>', '</a>',
      '</li>', '</ol>', '</li>', '</ol>', '</li>',
      '<li class="' + className + '-item ' + className + '-level-1">',
      '<a class="' + className + '-link" href="#title_2">',
      // '<span class="' + className + '-number">2.</span> ',
      '<span class="' + className + '-text">Title 2</span>', '</a>',
      '<ol class="' + className + '-child">',
      '<li class="' + className + '-item ' + className + '-level-2">',
      '<a class="' + className + '-link" href="#title_2_1">',
      // '<span class="' + className + '-number">2.1.</span> ',
      '<span class="' + className + '-text">Title 2.1</span>', '</a>', '</li>',
      '</ol>', '</li>',
      '<li class="' + className + '-item ' + className + '-level-1">',
      '<a class="' + className + '-link" href="#title_3">',
  ...
  it('No id attribute', () => {
    const className = 'f';
    const input = [ '<h1>foo</h1>', '<h1 id="">bar</h1>' ].join('');

    const expected = [
      `<ol class="${className}">`,
      `<li class="${className}-item ${className}-level-1">`,
      `<a class="${className}-link"><span class="${
          className}-text">foo</span></a>`,
      '</li>', `<li class="${className}-item ${className}-level-1">`,
      `<a class="${className}-link"><span class="${
          className}-text">bar</span></a>`,
      '</li></ol>'
    ].join('');
  ...
  it('non-ASCII id', () => {
    ...
    const input = [
      `<h1 id="${zh}">${zhs}</h1>`, `<h1 id="${de}">${des}</h1>`,
      `<h1 id="${ru}">${rus}</h1>`
    ].join('');
    ...
    const expected = [
      `<ol class="${className}">`,
      `<li class="${className}-item ${className}-level-1">`,
      `<a class="${className}-link" href="#${encodeURL(zh)}"><span class="${
          className}-text">${zhs}</span></a>`,
      '</li>', `<li class="${className}-item ${className}-level-1">`,
      `<a class="${className}-link" href="#${encodeURL(de)}"><span class="${
          className}-text">${des}</span></a>`,
      '</li>', `<li class="${className}-item ${className}-level-1">`,
      `<a class="${className}-link" href="#${encodeURL(ru)}"><span class="${
          className}-text">${rus}</span></a>`,
      '</li></ol>'
    ].join('');
