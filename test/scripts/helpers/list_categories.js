...
describe('list_categories', () => {
  ...
  const listCategories =
      require('../../../lib/plugins/helper/list_categories').bind(ctx);
  ...
  it('specified collection', () => {
    const result = listCategories(Category.find({parent : {$exists : false}}));
  ...
  it('style: false', () => {
    const result = listCategories({style : false});
  ...
  it('depth', () => {
    const result = listCategories({depth : 1});
  ...
  it('orderby', () => {
    const result = listCategories({orderby : 'length'});
  ...
  it('order', () => {
    const result = listCategories({order : -1});
  ...
  it('transform', () => {
    const result =
        listCategories({transform(name) { return name.toUpperCase(); }});
  ...
  it('separator (blank)', () => {
    const result = listCategories({style : false, separator : ''});
  ...
  it('children-indicator', () => {
    const result = listCategories({children_indicator : 'has-children'});

    result.should.eql([
      '<ul class="category-list">', '<li class="category-list-item">',
      '<a class="category-list-link" href="/categories/bat/">bat</a><span class="category-list-count">1</span>',
      '</li>', '<li class="category-list-item has-children">',
      '<a class="category-list-link" href="/categories/baz/">baz</a><span class="category-list-count">4</span>',
      '<ul class="category-list-child">', '<li class="category-list-item">',
      '<a class="category-list-link" href="/categories/baz/bar/">bar</a><span class="category-list-count">2</span>',
      '</li>', '</ul>', '</li>', '<li class="category-list-item">',
  ...
  it('show-current', () => {
    const result = listCategories({show_current : true});
