...
File.prototype.read = function(
    options,
    callback) { return readFile(this.source, options).asCallback(callback); };

File.prototype.readSync = function(
    options) { return readFileSync(this.source, options); };
...
File.prototype.statSync = function(options) { return statSync(this.source); };
